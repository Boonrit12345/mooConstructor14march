...
import 'package:mooconstructor14march/example/crud.dart';

class DashboardPageExample extends StatefulWidget {
  @override
  _DashboardPageExampleState createState() => _DashboardPageExampleState();
}

class _DashboardPageExampleState extends State<DashboardPageExample> {
  String carModel;
  String carColor;

  var cars;

  crudExampleMedthods crudObj = new crudExampleMedthods();
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: (cars != null)? _carList() : Center(child: Text('Load data .....')),
    );
  }
}
